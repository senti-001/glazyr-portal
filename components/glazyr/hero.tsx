        ...
        <section className="relative min-h-screen flex items-center justify-center overflow-hidden pt-20">
            ...
            <div className="relative z-10 mx-auto max-w-7xl px-6 text-center">
                ...
                <h1 className="text-4xl sm:text-5xl md:text-7xl font-bold tracking-tight text-foreground leading-tight text-balance mb-6">
                    Give Your Agents
                    <br />
                    <span className="text-primary">the Eyes of a Machine</span>
                </h1>

                {/* Subline */}
                <p className="mx-auto max-w-2xl text-lg md:text-xl text-muted-foreground leading-relaxed mb-10 text-pretty">
                    Stop waiting for screenshots. <strong>Direct-to-GPU frame access</strong> for autonomous systems. 60fps vision, unlimited parallelism, and built-in anti-bot stealth.
                </p>
                ...
                <div className="mt-16 grid grid-cols-2 md:grid-cols-4 gap-6 max-w-3xl mx-auto">
                    {[
                        { value: "Direct", label: "GPU Access" },
                        { value: "Unlimited", label: "Parallelism" },
                        { value: "60 FPS", label: "Real-time Vision" },
